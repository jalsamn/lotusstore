...
ActiveRecord::Schema.define(version: 20150906065008) do

  create_table "aremanagers", force: :cascade do |t|
    t.integer  "zipcode"
    t.integer  "zone"
  ...
  create_table "deliveryzones", force: :cascade do |t|
    t.integer  "zipcode"
    t.integer  "zone"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "spree_areamanagers", force: :cascade do |t|
    t.integer  "zipcode"
    t.integer  "zone"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "spree_articles", force: :cascade do |t|
    t.string   "name"
    t.string   "author"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "spree_cases", force: :cascade do |t|
  ...
  create_table "spree_revproducts", force: :cascade do |t|
    t.string   "name"
    t.integer  "sku"
    t.integer  "barcode"
    t.string   "category"
  ...
  create_table "spree_temp_po_items", force: :cascade do |t|
    t.integer "po_id"
    t.integer "variant_id"
  end

  create_table "spree_temp_pos", force: :cascade do |t|
    t.integer  "po_id"
    t.integer  "var_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "spree_timeslots", force: :cascade do |t|
    t.date     "ddate"
    t.string   "dtime"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "spree_zipcodes", force: :cascade do |t|
    t.integer  "code"
    t.integer  "zone"
    t.datetime "created_at"
    t.datetime "updated_at"
